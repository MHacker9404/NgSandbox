...
function generateEntities() {
    tsGen.generate({
        inputFileName: './WebApiDb.metadata.json',
        outputFolder: '../ClientApp/src/app/breeze-js/models/entities/',
...
function generateMetadata() {
    ...
    var spawnInfo = spawnExt('./bin/metadatagenerator', [
        '-i',
        '../WebApis/Data.EF/bin/Debug/Data.EF.dll',
        '-o',
        './WebApiDb.metadata.json'
    ]);

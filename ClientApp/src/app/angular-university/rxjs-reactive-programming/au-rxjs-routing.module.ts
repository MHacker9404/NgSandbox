...
const routes: Routes = [
    {
        ...
        children: [
            ...
            {
                path: 'section-9',
                loadChildren: () => import('./section-9/section-9.component').then(mod => mod.Section9Module),
            },
            {
                path: 'section-10',
                loadChildren: () => import('./section-10/section-10.component').then(mod => mod.Section10Module),
            },
            {
                path: 'section-11',
                loadChildren: () => import('./section-11/section-11.component').then(mod => mod.Section11Module),
            },
            {
                path: 'section-12',
                loadChildren: () => import('./section-12/section-12.component').then(mod => mod.Section12Module),
            },
        ],
    },
];
